...
ittehad_dashboard.icons = {
	...
	// Recycling arrows (scrap/raw material feed), same weight/viewBox as the other KPI icons.
	scrap: `<svg viewBox="0 0 48 48" fill="none" stroke="currentColor" stroke-width="3.2" stroke-linecap="round" stroke-linejoin="round"><path d="M15 6L8 18h7l-4.5 7.5"/><path d="M30.5 7.5l7 12-6.2 3.6 7 4"/><path d="M37 31.5l-7 10.5-4-6.5"/><path d="M18.5 40H8.5l4-7"/></svg>`,
	// Extruded rectangular billet (ingot), same pseudo-3D layered style as coil/truck.
	billet: `<svg viewBox="0 0 48 48" fill="none"><rect x="4" y="21" width="33" height="14" rx="2.5" fill="currentColor"/><path d="M4 21l8-8h29l-8 8H4z" fill="currentColor" opacity=".65"/><path d="M37 21l-8-8v14l8-8z" fill="currentColor" opacity=".4"/></svg>`,
